      ...
      body: Container(
        decoration: const BoxDecoration(
            gradient: LinearGradient(
                ...
                colors: [
              Color.fromRGBO(56, 173, 174, 1),
              Color.fromRGBO(205, 41, 90, 1)
            ])),
        child: Center(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    // ElevatedButton(
                    //   onPressed: (){
                    //     Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => SignupWidget()));
                    //   },
                    //   child: const Text(
                    //     "Signup",
                    //     style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              // onTap:(){
                              //   Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => Availability()));
                              // },
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              // onTap: (){
                              //   Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => Description()));
                              // },
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
